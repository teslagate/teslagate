...
<meta http-equiv="content-type" content="text/html;charset=utf-8" />
    ...
    <title>Referral Commission | <?= $title ?></title>
   ...
   <?php include'includes/left-side.php'; ?>
    ...
    <div class="content-body">
        <div class="container">
            ...
            <div>
                <h2 class="hk-pg-title font-weight-600 mb-10">Direct Bonus Statement</h2>
            </div>
            <!-- /Title -->
        </div>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <thead>
                                    ...
                                    <tr align="center">
                                        ...
                                        <th style="text-align:center;">Downline Id</th>
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT * FROM `direct_income` WHERE `userid`='" . $userid . "' ORDER BY `id` DESC";
                                    ...
                                    ?>
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" style="padding:3px;"><?= $fetch['dowlineid'] ?></td>
